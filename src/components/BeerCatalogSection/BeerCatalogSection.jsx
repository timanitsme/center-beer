...
export default function BeerCatalogSection({filters, filterButtons, breweryId}){
    const header = {
    ...
    return(
        <div className={styles.sectionContainer}>
            ...
            <BeerCatalog withHeader={false} filters={filters} filterButtons={filterButtons} breweryId={breweryId}></BeerCatalog>
        </div>
    )
}