            ...
            <div className={styles.bottledBeerCard}>
                <div className={styles.cardTop}>
                    <div className={styles.textContainer}>
                        ...
                        <p className={`${styles.textActive} ma-p ${styles.breweryAlias}`} title={`${cardInfo?.brewery}`} onClick={() => goToBreweryPage(cardInfo?.brewery_alias)}>{cardInfo?.brewery}{cardInfo?.brewery && cardInfo?.country && ","} {cardInfo?.country}</p>
                    </div>
                    <div>
