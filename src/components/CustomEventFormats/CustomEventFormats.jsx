    ...
    const formats = [
        ...
        {id: 2, Icon: CircleQuarterIcon, title: "Частичная аренда", description: "днём бар полностью ваш до 19:00", price: "от 30 000 ₽", condition: <>
                ...
                <br/><p>👨‍🍳 Комплимент от шеф-повара</p>
                    ...
                    <br/><p>🎤 Ведущий, живая музыка, фотограф, DJ</p>
                    <br/><p>👨‍🍳 Мастер-класс от шеф-повара</p></>},
        {id: 3, Icon: StarIcon, bg: true, title: "Все включено", description: "еда, напитки, программа, фото и видео. Всё под одной крышей", price: "от 100 000 ₽", condition: <><li>Полная аренда</li><li>Ведущий</li><li>Диджей</li><li>Welcome-drink</li><li>Комбо-наборы</li><li>Декор</li><li>Фото и видео</li></>},
        {id: 4, Icon: HybridCircleIcon, title: "Гибрид", description: "Индивидуальное решение для вашего формата", price: "Договорная цена", condition: <><li>Ведущий от <b>15 000 ₽</b></li><li>Диджей от <b>20 000 ₽</b></li><li>Декор от <b>7 000 ₽</b></li><li>Фото/видео от <b>10 000 ₽</b></li><li>Тематические сеты/квизы от <b>5 000 ₽</b></li></>},
    ]
