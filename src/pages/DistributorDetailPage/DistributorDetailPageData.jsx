...
export const getDistributorDetailPagePaths = () => paths;
export const getDistributorDetailPageFilters = () => filters;
export const getDistributorDetailPageFilterButtons = () => filterButtons;